...
function africanAnimalsOnly(animals) {
...
function calcWeight(animals) {
  ...
  for (const key in animals) {
    ...
    result.avrg = result.avrg + animal.weight_kg;
  }

  return result.avrg / result.count;
}

const avrgWeight = calcWeight(animals);
