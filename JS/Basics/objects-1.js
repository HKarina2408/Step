const user = { name: "Karina", age: 24, email: "email@gmail.com" };
const user2 = { name: "Igor", age: 34, email: "email2@gmail.com" };

const obj = { b: false };
// key(name, age, email)
// value (Karina, 24, email@gmail.com)
...
console.log(
  `${user3.name} ${user3.surname} ${user3.age} ${user3.email} ${user3.password}`
);

const key = "Karina".toUpperCase();
