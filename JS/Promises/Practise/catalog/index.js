class Catalog {
  ...
  //     Завдання:
  // - Додайте метод renderGoodsOfCategory(category) - він має виводити всі товари категорії,
  // роблячи запит на https://fakestoreapi.com/products/category/jewelery,
  // де jewerely - одна з можливих категорій
