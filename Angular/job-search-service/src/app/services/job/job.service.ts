...
export class JobService {
  ...
  private API_KEY = 'd00a76e48fmsh9d440f18bf720a2p1f3adbjsnfd72a7d2f507';
  ...
  jobs: JobType[] = [
    {
      ...
      job_description: 'Junior Full Stack Web Developer working on in-house tools using C#, .NET Core, Vue.js, and Kendo.js.',
      job_is_remote: false,
      ...
      job_google_link: 'https://www.google.com/search?gl=us&hl=en&rciv=jb&q=web+developer+in+texas+usa&start=0',
    ...
    },
    {
      ...
      job_apply_link: 'https://careers.google.com/jobs/results/123456789/software-engineer/',
      job_apply_is_direct: true,
      job_apply_quality_score: 0.89,
      job_description: 'Work on developing and scaling innovative software solutions for Google Cloud.',
      job_is_remote: true,
      ...
      job_google_link: 'https://www.google.com/search?gl=us&hl=en&rciv=jb&q=software+engineer+in+california&start=0',
      ...
      job_required_skills: 'Python, Java, C++, Cloud Infrastructure, API development',
      job_required_education: "Bachelor's in Computer Science or equivalent experience",
